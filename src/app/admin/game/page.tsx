  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <header className="bg-gray-900 border-b border-gray-800 px-6 py-4 flex items-center gap-4 sticky top-0 z-10">
        ...
        <Link href="/admin/players" className="ml-auto text-sm bg-gray-800 hover:bg-gray-700 text-gray-300 px-4 py-2 rounded-lg transition-colors">
          👥 Hráči
        </Link>
        <Link href="/hra" target="_blank" className="text-sm bg-gray-800 hover:bg-gray-700 text-gray-300 px-4 py-2 rounded-lg transition-colors">
          ↗ Zobrazit Game Mode
        </Link>
      </header>
